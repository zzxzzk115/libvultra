...
struct ImGuiGraphNode_RuntimeNodeStyleState
{
...
struct ImGuiGraphNodeContextCache
{
    ...
    std::map<ImGuiID, ImGuiGraphNode_RuntimeNodeStyleState> runtimeNodeStyles;
    std::vector<ImGuiID> runtimeTextureDoubleClicked;
