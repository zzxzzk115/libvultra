...
namespace vultra
{
    namespace
    {
        ...
        ScriptVec4 add(const ScriptVec4& a, const ScriptVec4& b) { return {a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w}; }
        ScriptVec4 sub(const ScriptVec4& a, const ScriptVec4& b) { return {a.x - b.x, a.y - b.y, a.z - b.z, a.w - b.w}; }
        ...
        float dot(const ScriptVec4& a, const ScriptVec4& b) { return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w; }
