...
namespace vultra
{
                                                 ...
                                                 FrameGraphResource      reflection)
    {
        ...
        const auto data = ctx.fg.addCallbackPass<PassData>(
            PASS_NAME,
            [source, reflection, extent](FrameGraph::Builder& builder, PassData& pd) {
                PASS_SETUP_ZONE;
    ...
    rhi::GraphicsPipeline SsrCompositePass::createPipeline(const rhi::PixelFormat colorFormat) const
    {
