...
namespace vultra
{
    namespace rhi
    {
        class WebGPUPipelineLayout final : public IPipelineLayout
        {
        public:
            WebGPUPipelineLayout(std::uintptr_t handle, std::vector<DescriptorSetLayoutKey>&& descriptorSetLayouts);
            ~WebGPUPipelineLayout() override = default;
