...
#define VULTRA_APP_DEFAULT_RENDERDOC 0
    ...
    void printUsage()
    {
        std::cout << "VultraEngine runtime\n\n"
                  ...
                  << "  vultra --editor [--mcp] [--mcp-port 8848] [--render-mode visible|offscreen|none] --project <project-dir>\n"
                  << "  vultra [--mcp] --render-mode none --project <project-dir> [--scene res://scenes/main.vscn]\n"
                  << "  vultra [--mcp] --render-mode offscreen --project <project-dir> [--scene res://scenes/main.vscn]\n"
                  ...
                  << "  --render-mode=none runs no-window simulation services and disables visual capture tools.\n"
