...
add_requires("spdlog", "magic_enum", "entt", "glm", "stb", "cereal", "vulkan-headers 1.4.309+0", "vulkan-memory-allocator-hpp", "fg", "cpptrace", "tinyexr", "joltphysics")
...
target("vultra")
    ...
    -- add packages
    add_packages("fmt", "spdlog", "stduuid", "cereal", "magic_enum", "entt", "glm", "stb", "vulkan-headers", "vulkan-memory-allocator-hpp", "fg", "cpptrace", "tinyexr", "joltphysics", { public = true })
