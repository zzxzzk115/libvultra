...
namespace vultra
{
    namespace rhi
    {
        VulkanDescriptorSetBuilderBackend::VulkanDescriptorSetBuilderBackend(const RenderDevice&    renderDevice,
        ...
        void VulkanDescriptorSetBuilderBackend::bind(const BindingIndex index, const ResourceBinding& r)
        {
            std::visit([this, index](const auto& info) { bind(index, info); }, r);
        }

        void VulkanDescriptorSetBuilderBackend::bind(const BindingIndex index, const bindings::SeparateSampler& info)
        {
            m_Bindings[index] = {DescriptorType::eSampler, 1, static_cast<int32_t>(m_ImageInfos.size())};
            addSampler(info.handle);
        }

        void VulkanDescriptorSetBuilderBackend::bind(const BindingIndex index, const bindings::CombinedImageSampler& info)
        {
            m_Bindings[index] = {
        ...
        void VulkanDescriptorSetBuilderBackend::bind(const BindingIndex index, const bindings::CombinedImageSamplerArray& info)
        {
        ...
        void VulkanDescriptorSetBuilderBackend::bind(const BindingIndex index, const bindings::SampledImage& info)
        {
        ...
        void VulkanDescriptorSetBuilderBackend::bind(const BindingIndex index, const bindings::StorageImage& info)
        {
        ...
        void VulkanDescriptorSetBuilderBackend::bind(const BindingIndex index, const bindings::UniformBuffer& info)
        {
            bindBuffer(index,
        ...
        void VulkanDescriptorSetBuilderBackend::bind(const BindingIndex index, const bindings::StorageBuffer& info)
        {
            bindBuffer(index,
        ...
        void VulkanDescriptorSetBuilderBackend::bind(const BindingIndex index, const bindings::AccelerationStructureKHR& info)
        {
            m_Bindings[index] = {
        ...
        DescriptorSetHandle VulkanDescriptorSetBuilderBackend::build(const DescriptorSetLayoutKey layoutKey)
        {
        ...
        void VulkanDescriptorSetBuilderBackend::clear()
        {
            m_Bindings.clear();
            m_ImageInfos.clear();
            m_BufferInfos.clear();
        ...
        void VulkanDescriptorSetBuilderBackend::addImage(const std::uintptr_t imageView, const ImageLayout imageLayout)
        {
        ...
        void VulkanDescriptorSetBuilderBackend::addSampler(const Sampler sampler)
        {
            assert(m_RenderDevice);
            m_ImageInfos.emplace_back(ImageInfo {
                .imageView = 0,
        ...
        void VulkanDescriptorSetBuilderBackend::addCombinedImageSampler(const std::uintptr_t imageView,
        ...
        void VulkanDescriptorSetBuilderBackend::addAccelerationStructure(const std::uintptr_t as)
        {
            m_AccelerationStructures.push_back(as);
        }

        void VulkanDescriptorSetBuilderBackend::bindBuffer(const BindingIndex   index,
