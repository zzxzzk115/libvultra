...
namespace vultra
{
    namespace rhi
    {
        class VulkanDescriptorSetAllocatorBackend final : public IDescriptorSetAllocatorBackend
        {
        public:
            explicit VulkanDescriptorSetAllocatorBackend(std::uintptr_t deviceHandle);
